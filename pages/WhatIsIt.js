    ...
    render() {
        return (
            <View style={{flex: 1, flexDirection: 'column'}}>
                <View>
                    <Text style={WIIstyles.loginButton} onPress={() => Actions.Login()}>Войти</Text>
                </View>
                <Swiper
                    showsButtons={false}
                ...
                >
                    <View style={WIIstyles.sliderItem}>
                        ...
                        <Text style={[textStyle.bold, WIIstyles.sliderHeader]}>Что это такое{"\n"}банкет-батл?</Text>
                        <View style={WIIstyles.sliderTextWrapper}>
                            <Text style={[textStyle.default, {textAlign: 'center'}]}>
                    ...
                    <View style={WIIstyles.sliderItem}>
                        ...
                        <Text style={[textStyle.bold, WIIstyles.sliderHeader]}>Как работает{"\n"}банкет-батл</Text>
                        <View style={WIIstyles.sliderTextWrapper}>
                            <Text style={[textStyle.default, {textAlign: 'center'}]}>
                                Создаете новый батл. Ожидаете предложений от ресторанов. Выбираете самое лучшее и договариваетесь с рестораном.
                            </Text>
                        </View>
                ...
                <View style={WIIstyles.createButtonWrapper}>
                    <Button onPress={() => this.goNext()} title="Создать новый батл"/>
                </View>
            </View>
        );
    }
